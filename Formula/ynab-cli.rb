class YnabCli < Formula
  include Language::Python::Virtualenv

  desc "CLI tool to interact with the YNAB API"
  homepage "https://github.com/sajal2692/ynab-cli"
  url "https://github.com/sajal2692/ynab-cli/archive/refs/tags/v1.0.0.tar.gz"
  sha256 "0b24043d4a90792e4dd0595ddeea62c0f7ac7d6d40b131aab5e4deb1b71d7238"
  license "MIT"
  ...
  test do
    assert_match "Usage", shell_output("#{bin}/ynab --help")
  end
end
